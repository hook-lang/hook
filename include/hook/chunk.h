...
typedef enum
{
  ...
  HK_OP_LOCAL_REF,              HK_OP_ELEMENT_REF,          HK_OP_FIELD_REF,
  HK_OP_GET_BY_REF,             HK_OP_SET_BY_REF,           HK_OP_CURRENT,
  HK_OP_JUMP,                   HK_OP_JUMP_IF_FALSE,        HK_OP_JUMP_IF_TRUE,
  HK_OP_JUMP_IF_TRUE_OR_POP,    HK_OP_JUMP_IF_FALSE_OR_POP, HK_OP_JUMP_IF_NOT_EQUAL,
  HK_OP_JUMP_IF_NOT_VALID,      HK_OP_NEXT,                 HK_OP_EQUAL,
  HK_OP_GREATER,                HK_OP_LESS,                 HK_OP_NOT_EQUAL,
  HK_OP_NOT_GREATER,            HK_OP_NOT_LESS,             HK_OP_BITWISE_OR,
  HK_OP_BITWISE_XOR,            HK_OP_BITWISE_AND,          HK_OP_LEFT_SHIFT,
  HK_OP_RIGHT_SHIFT,            HK_OP_ADD,                  HK_OP_SUBTRACT,
  HK_OP_MULTIPLY,               HK_OP_DIVIDE,               HK_OP_QUOTIENT,
  HK_OP_REMAINDER,              HK_OP_NEGATE, HK_OP_NOT,    HK_OP_BITWISE_NOT,
