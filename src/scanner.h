...
typedef enum
{
  ...
  TOKEN_KIND_IFBANG_KW,  TOKEN_KIND_IMPORT_KW,    TOKEN_KIND_IN_KW,       TOKEN_KIND_INOUT_KW,
  TOKEN_KIND_LET_KW,     TOKEN_KIND_LOOP_KW,      TOKEN_KIND_MATCH_KW,    TOKEN_KIND_NIL_KW,
  TOKEN_KIND_RETURN_KW,  TOKEN_KIND_STRUCT_KW,    TOKEN_KIND_TRUE_KW,     TOKEN_KIND_VAR_KW,
  TOKEN_KIND_WHILE_KW,   TOKEN_KIND_WHILEBANG_KW, TOKEN_KIND_NAME
} TokenKind;
