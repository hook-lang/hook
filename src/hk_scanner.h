...
typedef enum
{
  ...
  TOKEN_IF,     TOKEN_IFBANG,       TOKEN_IN,         TOKEN_LOOP,   TOKEN_MATCH,     TOKEN_MUT,       TOKEN_NIL,
  TOKEN_RETURN, TOKEN_STRUCT,       TOKEN_TRUE,       TOKEN_USE,    TOKEN_VAL,       TOKEN_WHILE,     TOKEN_WHILEBANG,
  TOKEN_NAME
} token_type_t;
